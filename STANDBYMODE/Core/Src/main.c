  ...
  if (__HAL_PWR_GET_FLAG(PWR_FLAG_SB) != RESET)
    {
  	  ...
  	  /** display  the string **/
  	  char *str = "Wake up from the STANDBY MODE\n\n";
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : PWR_WAKEUP_PIN13_Pin */
  GPIO_InitStruct.Pin = PWR_WAKEUP_PIN13_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(PWR_WAKEUP_PIN13_GPIO_Port, &GPIO_InitStruct);
